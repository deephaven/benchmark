...
public class LastByTest {
    ...
    public void lastBy1Group2Cols() {
        var q = "source.last_by(by=['str1'])";
        runner.test("LastBy- 1 Group 250 Unique Vals", 250, q, "str1", "int1");
    }

    @Test
    public void lastBy1Group2ColsLarge() {
        var q = "source.last_by(by=['str3'])";
        runner.test("LastBy- 1 Group 1M Unique Vals", 1000000, q, "str3", "int1");
    }

    @Test
    public void lastBy2Groups3Cols() {
        var q = "source.last_by(by=['str1', 'str2'])";
        runner.test("LastBy- 2 Group 160K Unique Combos", 160000, q, "str1", "str2", "int1");
    }
